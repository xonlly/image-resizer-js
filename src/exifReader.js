  ...
  (typeof exports !== 'undefined' && exports !== null
    ...
    */
    ...
    ExifReader.prototype._checkImageHeader = function() {
      if (
        this._dataView.byteLength < this._MIN_DATA_BUFFER_LENGTH ||
        this._dataView.getUint16(0, false) !== this._JPEG_ID
      ) {
      ...
      while (true) {
        ...
        if (this._isApp1ExifMarker(dataView, appMarkerPosition)) {
          fieldLength = dataView.getUint16(
            appMarkerPosition + this._APP_MARKER_SIZE,
            false,
          );
        ...
        _results.push(
          (appMarkerPosition += this._APP_MARKER_SIZE + fieldLength),
        );
      }
      return _results;
    };

    ExifReader.prototype._isApp1ExifMarker = function(
      dataView,
      appMarkerPosition,
    ) {
      return (
        dataView.getUint16(appMarkerPosition, false) === this._APP1_MARKER &&
        dataView.getUint32(appMarkerPosition + this._APP_ID_OFFSET, false) ===
          this._BYTES_Exif &&
        dataView.getUint8(
          appMarkerPosition + this._APP_ID_OFFSET + 4,
          false,
        ) === 0x00
      );
    };
    ...
    ExifReader.prototype._getIfdOffset = function() {
      return (
        this._tiffHeaderOffset + this._getLongAt(this._tiffHeaderOffset + 4)
      );
    };
    ...
    ExifReader.prototype._readExifIfd = function() {
      ...
      if (this._tags['Exif IFD Pointer'] != null) {
        ifdOffset =
          this._tiffHeaderOffset + this._tags['Exif IFD Pointer'].value;
    ...
    ExifReader.prototype._readGpsIfd = function() {
      ...
      if (this._tags['GPS Info IFD Pointer'] != null) {
        ifdOffset =
          this._tiffHeaderOffset + this._tags['GPS Info IFD Pointer'].value;
    ...
    ExifReader.prototype._readIfd = function(ifdType, offset) {
      ...
      for (
        fieldIndex = _i = 0;
        0 <= numberOfFields ? _i < numberOfFields : _i > numberOfFields;
        fieldIndex = 0 <= numberOfFields ? ++_i : --_i
      ) {
    ...
    ExifReader.prototype._readTag = function(ifdType, offset) {
      ...
      if (this._typeSizes[tagType] * tagCount <= 4) {
        ...
        tagValue = this._getTagValue(
          this._tiffHeaderOffset + tagValueOffset,
          tagType,
          tagCount,
        );
      }
      ...
      if (this._tagNames[ifdType][tagCode] != null) {
        if (
          this._tagNames[ifdType][tagCode]['name'] != null &&
          this._tagNames[ifdType][tagCode]['description'] != null
        ) {
          tagName = this._tagNames[ifdType][tagCode]['name'];
          tagDescription = this._tagNames[ifdType][tagCode]['description'](
            tagValue,
          );
        } else {
      ...
      gps: {
        0x0000: {
          ...
          description: function(value) {
            ...
            if (
              value[0] === (_ref = value[1]) &&
              _ref === 2 &&
              (value[2] === (_ref1 = value[3]) && _ref1 === 0)
            ) {
              return 'Version 2.2';
            } else {
              return 'Unknown';
            ...
            padZero = function(num) {
              ...
              return (
                (function() {
                  ...
                  _results = [];
                  for (
                    i = _i = 0, _ref = 2 - ('' + Math.floor(num)).length;
